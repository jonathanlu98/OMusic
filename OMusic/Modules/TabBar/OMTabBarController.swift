...
class OMTabBarController: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        OMPlayer.shared.menuView.frame = CGRect.init(x: 0, y: self.tabBar.mj_y-CGFloat(PLAYER_MENU_VIEW_HEIGHT)-SAFE_AREA_BOTTOM, width: SCREEN_WIDTH, height: CGFloat(PLAYER_MENU_VIEW_HEIGHT))
        self.view.addSubview(OMPlayer.shared.menuView)
    }
    ...
    private func loadViewControllers() {
        ...
        let homeViewController = OMHomeViewController()
        ...
        let libraryViewController = OMLibraryViewController()
